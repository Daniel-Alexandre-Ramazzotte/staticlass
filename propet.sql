...
CREATE TABLE questions (
    ...
    -- Colunas para as 5 alternativas
...
VALUES (UUID(), "teste@email.com", "HASH", "Teste zero");

select * from questions;

select * from users;	

-- PRECISA CONCERTAR ISSO AQUI VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV
-- Questoes com imagem
...
VALUES
        ...
        (18, "Considere que existe uma urna na qual foram colocadas 200 esferas de plásticos, e cada uma delas possui um pedaço de papel no seu interior. As esferas são coloridas, sendo uma de cada cor. Os pedaços de papel, então, trazem números de 1 a 200, diferentes a cada esfera. Qual das alternativas apresenta a probabilidade de que, ao sortear uma dessas esferas, ela tenha um número divisível por 3 e por 5 ao mesmo tempo?", "13.0%", "6.5%", "3.25%", "9.75%", "9%", "B", "Para saber quantos divisores de 3 e 5 têm entre 1 a 200, primeiro temos que achar o divido comum: -MMC de 3 e 5 = 15 Sabendo o fator comum, basta dividi-lo pela quantidade: 200/15 = 13 divisores comum Probabilidade: Quero/Total; P = 13/200 {divide por dois para ciar na base 10}; P = 6,5/100; P = 6,5 %"),
